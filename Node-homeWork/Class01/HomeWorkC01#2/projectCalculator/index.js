...
// const calcSum = formCalc.calculator(15,5,formCalc.sum);
// console.log(calcSum);
// const calcSub = formCalc.calculator(15,5,formCalc.subtract);
// console.log(calcSub);
// const calcMul = formCalc.calculator(15,5,formCalc.multiply);
// console.log(calcMul);
// const calcDev = formCalc.calculator(15,5,formCalc.devide);
// console.log(calcDev);
...
import {calculator, sum, subtract, multiply, devide} from "./calculatorModule.js";

const calcSum = calculator(15,5,sum);
console.log(calcSum);
const calcSub = calculator(15,5,subtract);
console.log(calcSub);
const calcMul = calculator(15,5,multiply);
console.log(calcMul);
const calcDev = calculator(15,5,devide);
console.log(calcDev)